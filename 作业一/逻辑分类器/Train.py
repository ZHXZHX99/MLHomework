...
if __name__=="__main__":
    ...
    res[0][0], res[0][1]  = logistic_model(training_inputs.T, training_labels.T, test_inputs.T, test_labels.T, num_iterations = 2000, learning_rate = 0.005, num_class = 0)
    ...
    res[1][0], res[1][1] = logistic_model(training_inputs.T, training_labels.T, test_inputs.T, test_labels.T, num_iterations = 2000, learning_rate = 0.005, num_class = 1)
